---
title: 'Temporal API：JavaScript Date 的現代替代方案'
date: '2026-03-14'
slug: 'temporal-api'
summary: 'JavaScript 的 Date API 壞了幾十年——可變物件、月份運算靜默溢出、跨環境解析行為不一致，逼得大家都去用 dayjs 或 moment.js。Temporal API 在 2026 年 3 月正式成為 ES2026 標準，原生內建在 Chrome、Firefox、Edge。幾個具體的範例，讓你直接在頁面上執行、對照。'
type: Post
language: zh-TW
---
