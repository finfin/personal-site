...
I spent some time digging into the spec and built [mermaid-mcp-app](https://github.com/nicholasgriffintn/mermaid-mcp-app) — an interactive Mermaid diagram tool I now use daily. This post walks through MCP Apps using that project as the running example.
